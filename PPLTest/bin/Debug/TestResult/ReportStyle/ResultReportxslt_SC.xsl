        ...
        <!--<fieldset>
				...
				<fieldset>
					...
					<div id="MyPannel_Role3" class="roleDiv">
						<table id="MyTitle_Role3">
							<tr >
                <td >
                  <div  class="mydiv" onclick="return showPane('ManageSupportTickets_PPLAdmin','MyTitle_Role3', this)">
                    Manage Support Tickets
                  </div>
                </td>
                <td >
                  <div  class="mydiv" onclick="return showPane('AuthorizationApproval_PPLAdmin','MyTitle_Role3', this)">
                    Authorization Approval
                  </div>
                </td>
                <td >
                  <div  class="mydiv" onclick="return showPane('CareCoordinatorSearch_PPLAdmin','MyTitle_Role3', this)">
                ...
                <td >
                    ...
                    Participant Search
								...
								<td>
									<div  class="mydiv" onclick="return showPane('ProvideApplication_PPLAdmin','MyTitle_Role3', this)">
										Provider Application
									</div>
								</td>
								<td>
                ...
                <td>
                  <div  class="mydiv" onclick="return showPane('Invoice_PPLAdmin','MyTitle_Role3', this)">
                    Invoice
                  </div>
                </td>
								<td>
              ...
              <div id="CareCoordinatorSearch_PPLAdmin">
                <xsl:for-each select="test-results/test-suite">
                  <xsl:if test="@Int_Role[.='PPL Admin']">
                    <xsl:if test="@Int_MenuName[.='Care Coordinator Search']">
                      <xsl:call-template name="IntegrationDeatil"/>
                    </xsl:if>
                  </xsl:if>
                </xsl:for-each>
