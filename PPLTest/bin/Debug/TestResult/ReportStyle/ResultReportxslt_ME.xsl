	...
	<xsl:template match="/">
		...
		<html>
			...
			<body>
				...
				<fieldset>
					<legend class="Clegend">-Role: MEVIPTestAdmin</legend>
					<div id="MyPannel_Role1" class="roleDiv">
						<table id="MyTitle_Role1">
							<tr >
								<td>
									<div  class="mydiv" onclick="return showPane('AuthorizationApproval_PPLAdmin','MyTitle_Role1', this)"  id="defaultTab_Role1">
										Authorization Approval
									</div>
								</td>
								<td >
									<div  class="mydiv" onclick="return showPane('Participant_PPLAdmin','MyTitle_Role1', this)">
										Participant
									</div>
								</td>
								<td>
									<div  class="mydiv" onclick="return showPane('ProvideApplication_PPLAdmin','MyTitle_Role1', this)">
										Provider Application
									</div>
								</td>
								<td>
									<div  class="mydiv" onclick="return showPane('ProvideSearch_PPLAdmin','MyTitle_Role1', this)">
										Provider Search
									</div>
								</td>
								<td>
								...
								<td>
									<div  class="mydiv" onclick="return showPane('ContactUs_PPLAdmin','MyTitle_Role1', this)">
										Contact Us
									</div>
								</td>
							</tr>
