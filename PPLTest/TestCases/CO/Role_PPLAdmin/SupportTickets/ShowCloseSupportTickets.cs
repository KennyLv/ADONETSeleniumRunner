 ...
 * Description:Show the Close SupportTickets Page
 */
namespace PPLTest.TestCases.CO.Role_PPLAdmin.SupportTickets
{
    [TestFixture]
    public class ShowCloseSupportTickets : BaseCase
    {
        ...
        public void TheUntitledTest()
        {
            try
            {
                selenium.Click("ctl00_MainBody_rdStatusList_1");
            }
            catch
            {
                verificationErrors.AppendLine("'Close' button can't find!\r\n");
            }
            ...
            InputSearchTime("Error after ticking Close box in Support Ticket link", caseExTime1);
            //
            ...
            try
            {
                ...
                selenium.Click("ctl00_MainBody_txtEndDateTo");
            ...
            InputSearchTime("Error after clicking Search button on Close page in Support Tickets link", caseExTime2);
            //


            //TimeSpan endTime = new TimeSpan(DateTime.Now.Ticks);
            //string caseExTime = endTime.Subtract(startTime).Duration().TotalSeconds.ToString();
            //InputSearchTime(caseExTime);
