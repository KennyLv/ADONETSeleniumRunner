...
<!--special for WY-->
	<xsl:template match="/">
        ...
        <!--<fieldset>
                ...
                <td >
                  <div  class="mydiv" onclick="return showPane('SupportBrokerSearch_PPLAdmin','MyTitle_Role3', this)">
                    Support Broker Search
                  </div>
                </td>
                <td >
              ...
              <div id="SupportBrokerSearch_PPLAdmin">
                <xsl:for-each select="test-results/test-suite">
                  <xsl:if test="@Int_Role[.='PPL Admin']">
                    <xsl:if test="@Int_MenuName[.='Support Broker Search']">
                      <xsl:call-template name="IntegrationDeatil"/>
                    </xsl:if>
                  </xsl:if>
                </xsl:for-each>
