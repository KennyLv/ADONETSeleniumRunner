	...
	<xsl:template match="/">		
		<html>			
			...
			<body>
				...
				<fieldset>
					...
					<div id="MyPannel_Role1" class="roleDiv">
						<table id="MyTitle_Role1">
							<tr >
                <td >
                  <div  class="mydiv" onclick="return showPane('ManageSupportTickets_PPLAdmin','MyTitle_Role1', this)">
                    Manage Support Tickets
                  </div>
                </td>
                <td >
									<div  class="mydiv" onclick="return showPane('ConsumerSearch_PPLAdmin','MyTitle_Role1', this)" id="defaultTab_Role1">
										Consumer Search
									</div>
								</td>
								<td>
									<div  class="mydiv" onclick="return showPane('ProviderSearch_PPLAdmin','MyTitle_Role1', this)">
										Provider Search
									</div>
								</td>
								<td>
									<div  class="mydiv" onclick="return showPane('Invoice_PPLAdmin','MyTitle_Role1', this)">
										Invoice
									</div>
								</td>
								<td>
									<div  class="mydiv" onclick="return showPane('Timesheets_PPLAdmin','MyTitle_Role1', this)">
										Timesheets
									</div>
								</td>
								<td>
									<div  class="mydiv" onclick="return showPane('TimesheetList_PPLAdmin','MyTitle_Role1', this)">
										Timesheet List
									</div>
								</td>
								<td>
									<div  class="mydiv" onclick="return showPane('SupportTickets_PPLAdmin','MyTitle_Role1', this)">
										Support Tickets
									</div>
								</td>
							
								<td>
									<div  class="mydiv" onclick="return showPane('Reporting_PPLAdmin','MyTitle_Role1', this)">
										Reporting
									</div>
								</td>
								<td>
									<div  class="mydiv" onclick="return showPane('ManageUsers_PPLAdmin','MyTitle_Role1', this)">
										Manage Users
									</div>
								</td>
								<td>
									<div  class="mydiv" onclick="return showPane('SubmitFeedback_PPLAdmin','MyTitle_Role1', this)">
										Submit Feedback
									</div>
								</td>
							</tr>
              ...
              <div id="ConsumerSearch_PPLAdmin">
								<xsl:for-each select="test-results/test-suite">
									<xsl:if test="@Int_Role[.='PPL Admin']">
										<xsl:if test="@Int_MenuName[.='Consumer Search']">
											<xsl:call-template name="IntegrationDeatil"/>
										</xsl:if>
									</xsl:if>
								</xsl:for-each>
							</div>
							<div id="ProviderSearch_PPLAdmin">
								<xsl:for-each select="test-results/test-suite">
									<xsl:if test="@Int_Role[.='PPL Admin']">
							...
							<div id="SubmitFeedback_PPLAdmin">
								<xsl:for-each select="test-results/test-suite">
									<xsl:if test="@Int_Role[.='PPL Admin']">
										<xsl:if test="@Int_MenuName[.='Submit Feedback']">
											<xsl:call-template name="IntegrationDeatil"/>
										</xsl:if>
									</xsl:if>
								</xsl:for-each>
				...
				<!--<fieldset>
					<legend class="Clegend">-Role: Consumer</legend>
					<div id="MyPannel_Role1" class="roleDiv">
						<table id="MyTitle_Role1">
							<tr >
								<td>
				...
				<fieldset>
					<legend class="Clegend">-Role: Provider</legend>
