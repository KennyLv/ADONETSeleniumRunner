		...
		<html>
			...
			<body>
				...
				<fieldset>
					...
					<div id="MyPannel_PPLAdmin" class="roleDiv">
						<table id="MyTitle_PPLAdmin">
							<tr >
								<td >
									<div  class="mydiv" onclick="return showPane('Participant_PPLAdmin','MyTitle_PPLAdmin', this)" id="defaultTab_PPLAdmin">
										Participant
									</div>
								</td>
								<td>
									<div  class="mydiv" onclick="return showPane('Invoice_PPLAdmin','MyTitle_PPLAdmin', this)">Invoice</div>
								</td>
								<td>
									<div  class="mydiv" onclick="return showPane('Timesheets_PPLAdmin','MyTitle_PPLAdmin', this)">Timesheets</div>
								</td>
								<td>
									<div  class="mydiv" onclick="return showPane('TimesheetList_PPLAdmin','MyTitle_PPLAdmin', this)">Timesheet List</div>
								</td>
								<td>
									<div  class="mydiv" onclick="return showPane('SupportTickets_PPLAdmin','MyTitle_PPLAdmin', this)">Support Tickets</div>
								</td>
								<td>
									<div  class="mydiv" onclick="return showPane('ManageUsers_PPLAdmin','MyTitle_PPLAdmin', this)">Manage Users</div>
								</td>
								<td>
									<div  class="mydiv" onclick="return showPane('ProvideApplication_PPLAdmin','MyTitle_PPLAdmin', this)">Provide Application</div>
								</td>
								<td>
									<div  class="mydiv" onclick="return showPane('ProvideSearch_PPLAdmin','MyTitle_PPLAdmin', this)">Provide Search</div>
								</td>
								<td>
									<div  class="mydiv" onclick="return showPane('AuthorizationApproval_PPLAdmin','MyTitle_PPLAdmin', this)">Authorization Approval</div>
								</td>
								<td>
									<div  class="mydiv" onclick="return showPane('CareConsultantSearch_PPLAdmin','MyTitle_PPLAdmin', this)">Care Consultant Search</div>
								</td>
								<td>
									<div  class="mydiv" onclick="return showPane('Reporting_PPLAdmin','MyTitle_PPLAdmin', this)">Reporting</div>
								</td>
								<td>
									<div  class="mydiv" onclick="return showPane('ContactUs_PPLAdmin','MyTitle_PPLAdmin', this)">Contact Us</div>
								</td>
							</tr>
						</table>
						<div  id="allFrames_PPLAdmin" style="border:0px solid #cfcfcf;width:1250px;" >
							...
							<div id="ProvideApplication_PPLAdmin">
								<xsl:for-each select="test-results/test-suite">
									<xsl:if test="@Int_Role[.='PPL Admin']">
										<xsl:if test="@Int_MenuName[.='Provide Application']">
											<xsl:call-template name="IntegrationDeatil"/>
										</xsl:if>
									</xsl:if>
								</xsl:for-each>
							...
							<div id="ProvideSearch_PPLAdmin">
								<xsl:for-each select="test-results/test-suite">
									<xsl:if test="@Int_Role[.='PPL Admin']">
										<xsl:if test="@Int_MenuName[.='Provide Search']">
											<xsl:call-template name="IntegrationDeatil"/>
										</xsl:if>
									</xsl:if>
								</xsl:for-each>
				...
				<fieldset>
					<legend class="Clegend">-Role: Care Consultant Agency</legend>
					<div id="MyPannel_CCAgency" class="roleDiv">
						<table id="MyTitle_CCAgency">
							<tr >
								<td >
									<div  class="mydiv" onclick="return showPane('Participant_CCAgency','MyTitle_CCAgency', this)" id="defaultTab_CCAgency">
										Participant
									</div>
								</td>
								...
								<td>
									<div  class="mydiv" onclick="return showPane('ManageUsers_CCAgency','MyTitle_CCAgency', this)">Manage Users</div>
								</td>

								<td>
									<div  class="mydiv" onclick="return showPane('CareConsultantSearch_CCAgency','MyTitle_CCAgency', this)">Care Consultant Search</div>
								</td>
								<td>
									<div  class="mydiv" onclick="return showPane('Reporting_CCAgency','MyTitle_CCAgency', this)">Reporting</div>
								</td>
								<td>
									<div  class="mydiv" onclick="return showPane('ContactUs_CCAgency','MyTitle_CCAgency', this)">Contact Us</div>
								</td>
							</tr>
						</table>
						<div  id="allFrames_CCAgency" style="border:0px solid #cfcfcf;width:1250px;" >
							<div id="Participant_CCAgency">
								<xsl:for-each select="test-results/test-suite">
									<xsl:if test="@Int_Role[.='Care Consultant Agency']">
										<xsl:if test="@Int_MenuName[.='Participant']">
											<xsl:call-template name="IntegrationDeatil"/>
										</xsl:if>
									</xsl:if>
							...
							<div id="CareConsultantSearch_CCAgency">
								<xsl:for-each select="test-results/test-suite">
									<xsl:if test="@Int_Role[.='Care Consultant Agency']">
										<xsl:if test="@Int_MenuName[.='Care Consultant Search']">
											<xsl:call-template name="IntegrationDeatil"/>
				...
				<fieldset>
					<legend class="Clegend">-Role: Care Consultant</legend>
					<div id="MyPannel_CC" class="roleDiv">
						<table id="MyTitle_CC">
							<tr >
								<td >
									<div  class="mydiv" onclick="return showPane('Participant_CC','MyTitle_CC', this)" id="defaultTab_CC">
										Participant
									</div>
								</td>
								<td>
									<div  class="mydiv" onclick="return showPane('TimesheetList_CC','MyTitle_CC', this)">Timesheet List</div>
								</td>
								<td>
									<div  class="mydiv" onclick="return showPane('ProvideSearch_CC','MyTitle_CC', this)">Provide Search</div>
								</td>
								<td>
									<div  class="mydiv" onclick="return showPane('ContactUs_CC','MyTitle_CC', this)">Contact Us</div>
								</td>
							</tr>
						</table>
						<div  id="allFrames_CC" style="border:0px solid #cfcfcf;width:1250px;" >
							<div id="Participant_CC">
								<xsl:for-each select="test-results/test-suite">
									<xsl:if test="@Int_Role[.='Care Consultant']">
										<xsl:if test="@Int_MenuName[.='Participant']">
											<xsl:call-template name="IntegrationDeatil"/>
										</xsl:if>
									</xsl:if>
				...
				<fieldset>
					<legend class="Clegend">-Role: State Admin</legend>
					<div id="MyPannel_StateAdmin" class="roleDiv">
						<table id="MyTitle_StateAdmin">
							<tr >
								<td >
									<div  class="mydiv" onclick="return showPane('Participant_StateAdmin','MyTitle_StateAdmin', this)" id="defaultTab_StateAdmin">
										Participant
									</div>
								</td>
								<td>
									<div  class="mydiv" onclick="return showPane('ProvideSearch_StateAdmin','MyTitle_StateAdmin', this)">Provide Search</div>
								</td>
								<td>
									<div  class="mydiv" onclick="return showPane('AuthorizationApproval_StateAdmin','MyTitle_StateAdmin', this)">Authorization Approval</div>
								</td>
								<td>
									<div  class="mydiv" onclick="return showPane('ContactUs_StateAdmin','MyTitle_StateAdmin', this)">Contact Us</div>
								</td>
							</tr>
						</table>
						<div  id="allFrames_StateAdmin" style="border:0px solid #cfcfcf;width:1250px;" >
							<div id="Participant_StateAdmin">
								<xsl:for-each select="test-results/test-suite">
									<xsl:if test="@Int_Role[.='State Admin']">
										<xsl:if test="@Int_MenuName[.='Participant']">
											<xsl:call-template name="IntegrationDeatil"/>
										</xsl:if>
									</xsl:if>
							...
							<div id="ProvideSearch_StateAdmin">
								<xsl:for-each select="test-results/test-suite">
									<xsl:if test="@Int_Role[.='State Admin']">
										<xsl:if test="@Int_MenuName[.='Provide Search']">
											<xsl:call-template name="IntegrationDeatil"/>
							...
							<div id="AuthorizationApproval_StateAdmin">
								<xsl:for-each select="test-results/test-suite">
									<xsl:if test="@Int_Role[.='State Admin']">
										<xsl:if test="@Int_MenuName[.='Authorization Approval']">
											<xsl:call-template name="IntegrationDeatil"/>
				...
				<fieldset>
					...
					<div id="MyPannel_Participant" class="roleDiv">
						<table id="MyTitle_Participant">
							<tr >
								<td>
									<div  class="mydiv" onclick="return showPane('TimesheetList_Participant','MyTitle_Participant', this)"  id="defaultTab_Participant">Timesheet List</div>
								</td>
								<td>
									<div  class="mydiv" onclick="return showPane('ContactUs_Participant','MyTitle_Participant', this)">Contact Us</div>
								</td>
								<td>
									<div  class="mydiv" onclick="return showPane('Invoice_Participant','MyTitle_Participant', this)">Invoice</div>
								</td>
							</tr>
						</table>
						<div  id="allFrames_Participant" style="border:0px solid #cfcfcf;width:1250px;" >
							<div id="TimesheetList_Participant">
								<xsl:for-each select="test-results/test-suite">
