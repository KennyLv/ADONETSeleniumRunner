		...
		<html>			
			...
			<body>
				...
				* Contact Us-->
				...
				<fieldset>
					...
					<div id="MyPannel_Role1" class="roleDiv">
						<table id="MyTitle_Role1">
							<tr >
								<td>
									<div  class="mydiv" onclick="return showPane('FaxesReceived_PPLAdmin','MyTitle_Role1', this)">Faxes Received</div>
								</td>
								<td>
									<div  class="mydiv" onclick="return showPane('MemberSearch_PPLAdmin','MyTitle_Role1', this)" id="defaultTab_Role1">Member Search</div>
								</td>
								<td>
									<div  class="mydiv" onclick="return showPane('EmployeeApplication_PPLAdmin','MyTitle_Role1', this)">Employee Application</div>
								</td>
								<td>
									<div  class="mydiv" onclick="return showPane('EmployeeSearch_PPLAdmin','MyTitle_Role1', this)">Employee Search</div>
								</td>								
								<td>
						...
						<div  id="allFrames_Role1" style="border:0px solid #cfcfcf;width:1250px;" >
							<div id="FaxesReceived_PPLAdmin">
								<xsl:for-each select="test-results/test-suite">
									<xsl:if test="@Int_Role[.='PPL Admin']">
										<xsl:if test="@Int_MenuName[.='Faxes Received']">
											<xsl:call-template name="IntegrationDeatil"/>
										</xsl:if>
									</xsl:if>
								</xsl:for-each>
							</div>
							<div id="MemberSearch_PPLAdmin">
								<xsl:for-each select="test-results/test-suite">
									<xsl:if test="@Int_Role[.='PPL Admin']">
										<xsl:if test="@Int_MenuName[.='Member Search']">
											<xsl:call-template name="IntegrationDeatil"/>
										</xsl:if>
									</xsl:if>
								</xsl:for-each>
							</div>
							<div id="EmployeeApplication_PPLAdmin">
								<xsl:for-each select="test-results/test-suite">
									<xsl:if test="@Int_Role[.='PPL Admin']">
										<xsl:if test="@Int_MenuName[.='Employee Application']">
											<xsl:call-template name="IntegrationDeatil"/>
										</xsl:if>
									</xsl:if>
								</xsl:for-each>
							</div>
							<div id="EmployeeSearch_PPLAdmin">
								<xsl:for-each select="test-results/test-suite">
									<xsl:if test="@Int_Role[.='PPL Admin']">
				...
				<fieldset>
					...
					<div id="MyPannel_Role2" class="roleDiv">
						<table id="MyTitle_Role2">
							<tr >
								<td >
									<div  class="mydiv" onclick="return showPane('ProviderHome_CCAgency','MyTitle_Role2', this)" id="defaultTab_Role2">
										Provider Home
									</div>
								</td>

								<td >
									<div  class="mydiv" onclick="return showPane('MemberSearch_CCAgency','MyTitle_Role2', this)" >
										Member Search
									</div>
								</td>
								<td>
									<div  class="mydiv" onclick="return showPane('EmployeeSearch_CCAgency','MyTitle_Role2', this)">
										Employee Search
									</div>
								</td>
								<td >
									<div  class="mydiv" onclick="return showPane('Authorizations_CCAgency','MyTitle_Role2', this)">
										Authorizations
									</div>
								</td>
								
								<td>
									<div  class="mydiv" onclick="return showPane('Timesheets_CCAgency','MyTitle_Role2', this)">Timesheets</div>
								</td>
								<td>
									<div  class="mydiv" onclick="return showPane('Reporting_CCAgency','MyTitle_Role2', this)">Reporting</div>
								</td>
								<td>
									<div  class="mydiv" onclick="return showPane('ManageUsers_CCAgency','MyTitle_Role2', this)">Manage Users</div>
								</td>
								<td>
									<div  class="mydiv" onclick="return showPane('ContactUs_CCAgency','MyTitle_Role2', this)">Contact Us</div>
								</td>
							</tr>
						</table>
						<div  id="allFrames_Role2" style="border:0px solid #cfcfcf;width:1250px;" >
							<div id="ProviderHome_CCAgency">
								<xsl:for-each select="test-results/test-suite">
									<xsl:if test="@Int_Role[.='Case Manager']">
										<xsl:if test="@Int_MenuName[.='Provider Home']">
											<xsl:call-template name="IntegrationDeatil"/>
										</xsl:if>
									</xsl:if>
								</xsl:for-each>
							</div>
							<div id="MemberSearch_CCAgency">
								<xsl:for-each select="test-results/test-suite">
									<xsl:if test="@Int_Role[.='Case Manager']">
										<xsl:if test="@Int_MenuName[.='Member Search']">
											<xsl:call-template name="IntegrationDeatil"/>
							...
							<div id="EmployeeSearch_CCAgency">
								<xsl:for-each select="test-results/test-suite">
									<xsl:if test="@Int_Role[.='Case Manager']">
										<xsl:if test="@Int_MenuName[.='Employee Search']">
											<xsl:call-template name="IntegrationDeatil"/>
							...
							<div id="Authorizations_CCAgency">
								<xsl:for-each select="test-results/test-suite">
									<xsl:if test="@Int_Role[.='Case Manager']">
										<xsl:if test="@Int_MenuName[.='Authorizations']">
											<xsl:call-template name="IntegrationDeatil"/>
										</xsl:if>
									</xsl:if>
								</xsl:for-each>
							</div>
							<div id="Timesheets_CCAgency">
								<xsl:for-each select="test-results/test-suite">
									<xsl:if test="@Int_Role[.='Case Manager']">
										<xsl:if test="@Int_MenuName[.='Timesheets']">
											<xsl:call-template name="IntegrationDeatil"/>
				...
				<fieldset>
					<legend class="Clegend">-Role: Member</legend>
					<div id="MyPannel_Role3" class="roleDiv">
						<table id="MyTitle_Role3">
							<tr >
								<td>
									<div  class="mydiv" onclick="return showPane('TimesheetList_CC','MyTitle_Role3', this)" id="defaultTab_Role3">Timesheet List</div>
								</td>
								<td>
									<div  class="mydiv" onclick="return showPane('ContactUs_CC','MyTitle_Role3', this)">Contact Us</div>
								</td>
							</tr>
						</table>
				...
				<fieldset>
					<legend class="Clegend">-Role: Provider Invoice</legend>
					<div id="MyPannel_Role4" class="roleDiv">
						<table id="MyTitle_Role4">
							<tr >
								<td>
									<div  class="mydiv" onclick="return showPane('Invoice_PI','MyTitle_Role4', this)" id="defaultTab_Role4">Invoice</div>
								</td>
								<td>
									<div  class="mydiv" onclick="return showPane('ContactUs_PI','MyTitle_Role4', this)">Contact Us</div>
								</td>
							</tr>
						</table>					
						<div  id="allFrames_Role4" style="border:0px solid #cfcfcf;width:1250px;" >							
							<div id="Invoice_PI">
								<xsl:for-each select="test-results/test-suite">
									<xsl:if test="@Int_Role[.='Provider Invoice']">
										<xsl:if test="@Int_MenuName[.='Invoice']">
											<xsl:call-template name="IntegrationDeatil"/>
										</xsl:if>
									</xsl:if>
				...
				<fieldset>
					<legend class="Clegend">-Role: Provider Timesheet</legend>
					<div id="MyPannel_Role5" class="roleDiv">
						<table id="MyTitle_Role5">
							<tr >
								<td >
									<div  class="mydiv" onclick="return showPane('ProviderHome_StateAdmin','MyTitle_Role5', this)" id="defaultTab_Role5">
										Provider Home
									</div>
								</td>
								<td>
									<div  class="mydiv" onclick="return showPane('AgencyWorkers_StateAdmin','MyTitle_Role5', this)">Agency Workers</div>
								</td>
								<td>
									<div  class="mydiv" onclick="return showPane('MemberSearch_StateAdmin','MyTitle_Role5', this)">Member Search</div>
								</td>
								<td>
									<div  class="mydiv" onclick="return showPane('Timesheets_StateAdmin','MyTitle_Role5', this)">Timesheets</div>
								</td>
								<td>
									<div  class="mydiv" onclick="return showPane('ContactUs_StateAdmin','MyTitle_Role5', this)">Contact Us</div>
								</td>
							</tr>
						</table>
						<div  id="allFrames_Role5" style="border:0px solid #cfcfcf;width:1250px;" >
							<div id="ProviderHome_StateAdmin">
								<xsl:for-each select="test-results/test-suite">
									<xsl:if test="@Int_Role[.='Provider Timesheet']">
										<xsl:if test="@Int_MenuName[.='Provider Home']">
											<xsl:call-template name="IntegrationDeatil"/>
										</xsl:if>
									</xsl:if>
							...
							<div id="AgencyWorkers_StateAdmin">
								<xsl:for-each select="test-results/test-suite">
									<xsl:if test="@Int_Role[.='Provider Timesheet']">
										<xsl:if test="@Int_MenuName[.='Agency Workers']">
											<xsl:call-template name="IntegrationDeatil"/>
										</xsl:if>
									</xsl:if>
								</xsl:for-each>
							</div>
							<div id="MemberSearch_StateAdmin">
								<xsl:for-each select="test-results/test-suite">
									<xsl:if test="@Int_Role[.='Provider Timesheet']">
										<xsl:if test="@Int_MenuName[.='Member Search']">
											<xsl:call-template name="IntegrationDeatil"/>
